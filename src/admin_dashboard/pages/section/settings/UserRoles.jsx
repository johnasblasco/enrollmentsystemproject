...
const UserRoles = () => {
    ...
    const handleSave = async (data, id) => {
        try {
            if (id) {
                await axios.post(`https://server.laravel.bpc-bsis4d.com/public/api/updateusertype/${id}`, data);
            } else {
                await axios.post("https://server.laravel.bpc-bsis4d.com/public/api/createusertype", data);
            }
            fetchRoles();
            setOpenModal(false);
        } catch (err) {
