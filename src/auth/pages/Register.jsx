                ...
                <section className="flex flex-col gap-4 justify-center items-center py-16">
                    <form
                        ...
                        <div className="flex justify-between pt-4 w-full">
                            ...
                            <button
                                type="submit"
                                className="hover:cursor-pointer px-6 py-2 bg-purple-600 text-white rounded hover:bg-purple-700"
                            >
                                Next
                            </button>
                        </div>
                    ...
                    <form
                        ...
                        <div className="flex justify-between pt-4">
                            <button
                                ...
                                className="hover:cursor-pointer  px-6 py-2 bg-gray-300 rounded hover:bg-gray-400"
                            >
                                Back
                            </button>
                            <button
